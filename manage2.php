        ...
        <div class="row align-items-center">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <div class="site-blocks-cover inner-page-cover print" style="background-image: url(images/test1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">
                ...
                <form class="print" action="suspend.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <input style="background-color:gray" type="submit" style="width: 200px" class="btn btn-primary py-1 px-5 text-white" value="Suspend Pass">
                </form>
                        </td>
                        <td>
