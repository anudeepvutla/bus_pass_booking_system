<?php
    ...
    if(isset($_POST['name'])){
     ...
     //	$abcd = "insert into pass(name, email, contact, date, dest, password) values ('$name', '$email', '$contact', '$date', '$dest', '$password')";
       // $query = mysqli_query($conn,$abcd);
      
    
		$nod = round((strtotime($date) - time())/(60*60*24))+1;
    $ab ="select price from destination where name = '$dest'";
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            ...
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
              <h1 class="text-white font-weight-light" style="background-color:silver;">Book Your Pass</h1>
  ...
  <div class="col-75">
    <div class="container">
      <form action="invoice.php" method="post">
            ...
            <div class="icon-container">
			  ...
			  <div>Rs. 
				<?php
					...
					$amt = $price;
					echo $amt;
          $abcd = "insert into pass(name, email, contact, date, dest,paid, password) values ('$name', '$email', '$contact', '$date', '$dest','$amt' ,'$password')";
         // $passmoney = "insert into pass(paid)values('$amt')";
          $link = mysqli_query($conn,$abcd);
				?>
			  </div>
            </div>
        ...
        <input type="submit" value="Continue to checkout" style="background-color:gray" class="btn">
      </form>
    </div>
  </div>
